...
final class SearchUtils {
    ...
    /**
     * Traduce il sort richiesto (nomi pubblici) in proprieta' JPA.
     *
     * Il campo su cui ordinare arriva dal client e non si puo' legare come
     * parametro: finirebbe concatenato nella query. Qui si confronta con un
     * elenco chiuso di valori ammessi e tutto il resto diventa 400.
     */
